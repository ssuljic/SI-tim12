...
public class DostavljacPreuzimanjePecivaJPanel extends JPanel {
	...
	public void validirajPodatke2() {
		if((Integer)getKolicinaJSpinner().getValue() == 0)
			throw new IllegalArgumentException("Kolicina ne može biti 0.");
		if((Integer)getKolicinaJSpinner().getValue() < 0)
			throw new IllegalArgumentException("Kolicina ne može biti negativne vrijednosti.");
	}
}
