...
public class RacunovodstvoSpaseniObracuniJPanel extends JPanel {
    ...
    public RacunovodstvoSpaseniObracuniJPanel() {
        setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Spašeni obracuni:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        ...
        JLabel obracunZaJLabel = new JLabel("Obracun za:");
        ...
        JLabel obracuniJLabel = new JLabel("Obracuni:");
        ...
        obracuniJTable.setModel(new DefaultTableModel(
                ...
                new String[]{
                        "Datum", "Broj", "Iznos", "Placen", "Obracunao", "Pocetak obracuna", "Kraj obracuna"
                }
        ) {
        ...
        obrisiObracunJButton = new JButton("Obriši obracun");
        ...
        public String getColumnName(int columnIndex) {
            switch (columnIndex) {
                ...
                case 4:
                    return "Obracunao";
                case 5:
                    return "Pocetak obracuna";
               case 6:
            	   	return "Kraj obracuna";
                default:
                    return null;
            }
        }
