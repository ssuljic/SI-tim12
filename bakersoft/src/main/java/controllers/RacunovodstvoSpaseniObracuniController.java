        ...
        return new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                if(rbSelektiranogRacuna == -1) {
                	JOptionPane.showMessageDialog(racunovodstvoSpaseniObracuniJPanel.getParent(), "Niste izabrali obracun");
                }
                else {
	                ...
	                JOptionPane.showMessageDialog(racunovodstvoSpaseniObracuniJPanel.getParent(), "Uspješno ste izbrisali obracun");
                }
            }
        };
    }
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                if(rbSelektiranogRacuna == -1) {
	                ...
	                try {
	                    ...
	                    document.close();
	                    JOptionPane.showMessageDialog(racunovodstvoSpaseniObracuniJPanel.getParent(), "Racun je spašen u privremeni direktorij " + System.getProperty("java.io.tmpdir") + "/Racun" + r.getId() + ".pdf.\nUkoliko ga želite zadržati snimite ga u neki drugi direktorij.\nNakon što klikente OK otvorit ce vam se dokument.");
